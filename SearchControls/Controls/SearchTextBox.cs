...
namespace SearchControls
{
    ...
    public partial class SearchTextBox : TextBox, IGrid
    {
        bool _isAutoRest = true;
        bool IGrid.isAutoReset => _isAutoRest;
        TextBox IGrid.textBox => this;
        ...
        public virtual void OnSearchGridLocationSizeChanged(SubFormLocationSizeEventArgs e)
        {
        ...
        protected override void OnCreateControl()
        {
            ...
            if (TopLevelControl != null)
            {
                ...
                TopLevelControl.VisibleChanged += (sender, e) =>
                  {
                      if(sender is Control c)
                      {
                          if (!c.Visible) SearchForm.Visible = false;
                      }
                  };
        ...
        /// 显示并设置网格高宽
        /// </summary>
        public void ShowSearchGrid() => SearchForm.ShowSearchGrid();

        /// <summary>
        /// 设置网格大小
        /// </summary>
        public void SetSearchGridSize() => SearchForm.SetSearchGridSize();

        /// <summary>
        /// 设置网格位置
        /// </summary>
        public void SetSearchGridLocation() => SearchForm.SetSearchGridLocation();
